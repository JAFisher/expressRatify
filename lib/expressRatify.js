...
var types = ["string", "text", "number", "email", "array"];
            ...
            _.find(data, function(index, key){
                ...
                if (!parameter && !index.conditional){
                    ...
                    if (index.type === "number" && !_.isNumber(parameter)){
                        // need a final test to see if it a number in a GET response
                        if (isNaN(parameter)){
                            message = {
                    ...
                    if (index.type === "array" && !_.isArray(parameter)){
                        message = {
                            message: "param: ("+index.param+") isn't a valid Array ("+parameter+"). ",
                            pass: false
                        };
                    }
